...
app.service('data', function(){
  ...
  this.services = [
    ...
    {service: "shopping cart", price: "$10 / month", description: "Includes shopping cart and payment pages. I will also set up a third party payment service that is linked directly to your bank card. The service gives you access to customer payment history, receipts, refunds, and more."},
